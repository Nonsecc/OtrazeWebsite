          ...
          <div className="px-8">
            ...
            <div className="space-y-8">
              <section>
                ...
                <div className="space-y-4">
                  <p className="[font-family:'Roboto',Helvetica] font-normal text-[#676b89] text-lg leading-7">
                    OTraze GmbH (or your legal entity, e.g., UG haftungsbeschränkt, sole proprietorship, etc.)
                  </p>
                  <p className="[font-family:'Roboto',Helvetica] font-normal text-[#676b89] text-lg leading-7">
              ...
              <section>
                ...
                <p className="[font-family:'Roboto',Helvetica] font-normal text-[#676b89] text-lg leading-7">
                  [Full name of the authorized representative, e.g., Managing Director]
                </p>
              </section>
              ...
              <section>
                ...
                <div className="space-y-2">
                  <p className="[font-family:'Roboto',Helvetica] font-normal text-[#676b89] text-lg leading-7">
                    Court of Registration: [e.g., Local Court of Berlin Charlottenburg]
                  </p>
                  <p className="[font-family:'Roboto',Helvetica] font-normal text-[#676b89] text-lg leading-7">
              ...
              <section>
                ...
                <p className="[font-family:'Roboto',Helvetica] font-normal text-[#676b89] text-lg leading-7">
                  Value Added Tax Identification Number according to § 27a German VAT Act: [DE 123456789]
                </p>
              </section>
              ...
              <section>
                ...
                <p className="[font-family:'Roboto',Helvetica] font-normal text-[#676b89] text-lg leading-7">
                  [Name, address (same as above or different if applicable)]
                </p>
              </section>
              ...
              <section>
                ...
                <p className="[font-family:'Roboto',Helvetica] font-normal text-[#676b89] text-lg leading-7">
                  As a service provider, we are responsible for our own content on these pages in accordance with general laws pursuant to § 7 para. 1 TMG. However, according to §§ 8 to 10 TMG, we as a service provider are not under obligation to permanently monitor submitted or stored information or to search for evidence that indicates illegal activities.
                </p>
              </section>
            </div>
          </div>
